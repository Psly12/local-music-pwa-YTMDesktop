...
export type PageServerLoad = Kit.ServerLoad<
	...
	MaybeWithVoid<App.PageData>,
	RouteId
>
export type EntryGenerator = Kit.EntryGenerator<RouteParams>
export type Actions = Kit.Actions<RouteParams>
export type ActionFailure<T extends Record<string, unknown> | undefined = undefined> =
	Kit.ActionFailure<T>
export type Action<T extends Record<string, unknown> | undefined = undefined> = Kit.Action<
	RouteParams,
	T,
	RouteId
>
